...
namespace Yusen.GExplorer.Utilities {
	...
	sealed class ScreenSaveListener : NativeWindow, IDisposable {
		private const int DefaultIntervalSecond = 50;
		private const double DefaultIntervalMillisecond = DefaultIntervalSecond * 1000;
		...
		public ScreenSaveListener() {
			...
			this.timer = new Timer(ScreenSaveListener.DefaultIntervalMillisecond);
