namespace Yusen.GExplorer.UserInterfaces {
	partial class ExternalCommandsEditForm {
		...
		private void InitializeComponent() {
			...
			this.tscpmiPropertyName = new Yusen.GExplorer.UserInterfaces.ToolStripContentPropertyMenuItem();
		...
		private ToolStripContentPropertyMenuItem tscpmiPropertyName;
	}
}