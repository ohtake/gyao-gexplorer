...
namespace Yusen.GExplorer.UserInterfaces {
	sealed partial class MainForm2 : BaseForm, IMainFormBindingContract, INotifyPropertyChanged {
		...
		private void MainForm2_Load(object sender, EventArgs e) {
			...
			BindingContractUtility.BindAllProperties<MainForm2, IMainFormBindingContract>(this, Program.RootOptions.MainFormOptions);
	...
	public sealed class MainFormOptions : FormOptionsBase, IMainFormBindingContract {
		...
		internal void NeutralizeUnspecificValues(MainForm2 mainForm) {
