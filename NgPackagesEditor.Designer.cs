namespace Yusen.GExplorer {
	partial class NgPackagesEditor {
		/// <summary>
		...
		private void InitializeComponent() {
			this.lvNgPackages = new System.Windows.Forms.ListView();
			...
			// lvNgPackages
			// 
			this.lvNgPackages.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
            this.chComment,
            this.chPropertyName,
            this.chPredicate,
            this.chWord,
            this.chCreated,
            this.chLastAbone});
			this.lvNgPackages.Dock = System.Windows.Forms.DockStyle.Fill;
			this.lvNgPackages.FullRowSelect = true;
			this.lvNgPackages.HeaderStyle = System.Windows.Forms.ColumnHeaderStyle.Nonclickable;
			this.lvNgPackages.HideSelection = false;
			...
			// grpList
			// 
			this.grpList.Controls.Add(this.lvNgPackages);
		...
		private System.Windows.Forms.ListView lvNgPackages;
