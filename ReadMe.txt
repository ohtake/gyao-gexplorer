...
対応ジャンルであってもリストビューに表示されないコンテンツもあるのでたまにはブラウザで確認してね

◆既知の不具合
並行取得がうまくいかない環境があるらしい
HTTPSのコネクションが張られた状態でIEベースのブラウザのウィンドウを閉じても背後でIEが走っているままのような気が
